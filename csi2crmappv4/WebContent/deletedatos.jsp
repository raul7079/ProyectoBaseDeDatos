...
<form action="deletedatos.jsp" method="post">
Seleccione un nombre para borrar sus datos: 
<select name="borrar">
  <%
  //Recorremos una tabla donde estan los datos de la query para sacar todos los datos de los pacientes
				...
				String query1 = "select idMedico, nombre, apellidos from medicos";
...
<%
String idMedico = request.getParameter("borrar");
String query="select * from medicos";
String queryHija="Delete from visitaMedica where idMedico="+idMedico;
String queryBorrar = "Delete from medicos where idMedico="+idMedico;
beanDB basededatos = new beanDB();
basededatos.delete(queryHija);
basededatos.delete(queryBorrar);
